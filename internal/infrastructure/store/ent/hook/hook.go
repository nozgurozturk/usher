...
// The LayoutFunc type is an adapter to allow the use of ordinary
// function as Layout mutator.
type LayoutFunc func(context.Context, *ent.LayoutMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LayoutFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.LayoutMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LayoutMutation", m)
	}
	return f(ctx, mv)
}
...
// The RowFunc type is an adapter to allow the use of ordinary
// function as Row mutator.
type RowFunc func(context.Context, *ent.RowMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RowFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.RowMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RowMutation", m)
	}
	return f(ctx, mv)
}
